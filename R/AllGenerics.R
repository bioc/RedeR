...
setGeneric ('updateCoordXY', signature='obj', 
            function (obj, g, delNodes=FALSE, delEdges=FALSE)
              standardGeneric ('updateCoordXY'), package='RedeR')
...
#-------------------------------------------------------------------------------
setGeneric ('selectEdges', signature='obj', function (obj, edges)    
  standardGeneric ('selectEdges'), package='RedeR')
setGeneric ('selectNodes', signature='obj', 
...
setGeneric ('relax', signature='obj', 
            function (obj,p1=100,p2=100,p3=100,p4=100,p5=100,
                      p6=10,p7=10,p8=100,p9=10,ps=FALSE)
