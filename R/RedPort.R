...
.getEdgeAttr <- function(){
  col1 <- c(
    "edgeWeight","edgeWidth","edgeColor","edgeType",
...
.getGraphAttr <- function(){
  ...
  col3<- c(
    'Hexadecimal or color name', "Numeric, 0-100", 
